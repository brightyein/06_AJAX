 ...
 * Generated at: 2024-06-12 02:43:28 UTC
...
public final class index_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final jakarta.servlet.http.HttpServletRequest request, final jakarta.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("	<button id=\"send-no-data\">SEND</button> <!-- 화면 이동없이 요청을 보내기 위해 a 태그 안쓰고 button 이용  -->\r\n");
      out.write("	\r\n");
      out.write("	<script>\r\n");
      out.write("	$(\"#send-no-data\").click(function() {\r\n");
      out.write("		\r\n");
      out.write("		$.ajax({ // key, value 로 프로퍼티 구성\r\n");
      out.write("			url:\"/chap01/receive\", // 요청 보낼 url\r\n");
      out.write("			type: \"get\", // 요청 방식\r\n");
      out.write("			success: function(data) { // 성공 시 콜백함수 (매개변수로 성공 데이터 받아 쓸 수 있음)\r\n");
      out.write("				alert(data);\r\n");
      out.write("			},\r\n");
      out.write("			error: function(error) { // 실패 시 콜백함수 (매개변수로 에러 정보 받아 쓸 수 있음)\r\n");
      ...
      out.write("	</script>\r\n");
      out.write("	\r\n");
      out.write("	<h3>2. data 로 값 전송 후 문자열 반환</h3>\r\n");
